...
const int ldrsen_2 = A2;
const int ldrsen_3 = A3;
const int ldrsen_4 = A4;
int buzzer = 7;
int value = 0;
int value_1 = 0; 
int value_2 = 0; 
...
void setup() {
  ...
  pinMode(ldrsen_2, INPUT);
  pinMode(ldrsen_3, INPUT);
  pinMode(ldrsen_4, INPUT);
  pinMode(7, OUTPUT);
  ...
  value_2 = analogRead(ldrsen_2) /4;
  value_3 = analogRead(ldrsen_3) /4;
  value_4 = analogRead(ldrsen_4) /4;
